          ...
          <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div className="-space-y-px rounded-md shadow-sm">
              <div>
                ...
                <input id="name" name="email" type="text" autoComplete="name" required className="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-pink-500 focus:outline-none focus:ring-pink-500 sm:text-sm" placeholder="You Name" />
              </div>
              <div>
