...
export default function Home() {
  return (
    <div className={styles.container}>
      ...
      <div className='hero mt-10'><img src="https://www.codeswear.com/_next/image?url=%2Fimg%2Fbanner-1.webp&w=1920&q=75" alt="this is banner" width={1200} height={900} className="mx-auto" /></div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">CodesWear Lets create awesome things</h1>
          ...
          <button className="flex mx-auto mt-16 text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-pink-600 rounded text-lg">Buy Now</button>
        </div>
      </section>
    </div>
  )
